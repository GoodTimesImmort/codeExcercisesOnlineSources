...
def drawBoard(board):
    ...
    # Print the numbers accros the top of the board.
    ...
    for row in range(15):
        ...
        # Create the string fo r this row on the board.
        boardRow = ''
...
def enterPlayerMove(previousMoves):
    ...
    while True:
        ...
        print('Enter a number form 0 to 59, a space, then a number from 0 to 14.')

def showInstructions():
    print('''Instructions:
You are the captain of the Simon, a treasure-hunting ship. Your current mission
is to use the sonar devices to find three sunken treasure chests at the bottom of
...
range. For exampe, the C marks are where chests are. the sonar device shows a
...
Press enter to continue... ''')
    ...
    print(''' When you drop a sona device directly on a chest, you retrieve it and the other
